# MySQL Data Types Reference (v8.4 / v9.0+)

MySQL supports a wide variety of SQL data types, categorizing them into numeric, string, date/time, spatial, and JSON types. 
