# MS SQL Server Data Types Reference (SQL Server 2022)

Microsoft SQL Server / Transact-SQL (T-SQL) supports standard relational data types along with specialized types for XML, native GUIDs (uniqueidentifiers), and modern JSON documents.
